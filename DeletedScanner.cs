...
namespace Micasa
{
    class DeletedScanner
    {
        ...
        ///         iii. If there is 1 or more records in the Photos table for
        ///              this folder then
        ...
        public void StartScanner(object token)
        {
